...
<nav class="navBar">
    ...
    <div class="lis">
        ...
        <li><a href="http://localhost:<?php echo $localhost_port; ?>/back_end/lista_agencias/listar_agencias.php"><i class="fas fa-solid fa-key"></i> Locações</a></li>
        <li><a href="http://localhost:<?php echo $localhost_port; ?>/back_end/lista_agencias/listar_agencias.php"><i class=""></i> Pedidos</a></li>
