...
<nav class="navBar">
    ...
    <div class="lis">
        ...
        <li class="login"><a href="http://localhost:<?php echo $localhost_port; ?>/back_end/login_funcionario/login_funcionario.php"><i class="fas fa-solid fa-key" style="color: #0b1e3c;"></i> Login Clientes</a></li>
    </div>
</nav>
